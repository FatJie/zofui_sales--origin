	        ...
	        <div id="main" >
	        	...
	        	<div id="content" >
                    ...
                    <div class="shop-box" v-if="itemout.name == 'shop'">
                        <div v-for="(item,iidx) in itemout.params.data" :key="iidx" @click="link" :data-url="item.appurl">
                                            ...
                                            <div class="btm-b">
                                                ...
                                                <div class="btm-info">
                                                    <div class="btm_price fmt-price">
                                                        ...
                                                        <div class="old" v-if="item.show_fx <= 0 && item.fanxm <= 0 && item.userpricejb <= 0 && item.oldprice">¥{{item.oldprice}}</div>
                                        ...
                                        <div class="btm-b">
                                            <div class="btm-info">
                                                <div class="btm_price fmt-price">
                                                    ...
                                                    <div class="old" v-if="(item.show_fx <= 0 && item.fanxm <= 0  && item.userpricejb <= 0) || itemout.params.istitle == 0 && item.oldprice > 0">¥{{item.oldprice}}</div>
                                                    <div class="btm_fx lbg-pri" v-if="item.show_fx > 0  && item.userpricejb <= 0">赚{{item.show_fx}}</div>
                                                    <div class="btm_fx lbg-pri" v-if="item.show_fx <= 0 && item.fanxm > 0 && item.userpricejb <= 0">返{{item.fanxm}}</div>
                                                    <div class="btm_fx lbg-pri" v-if="item.userpricejb > 0">{{item.userpricejb*100/100}} {{params.umname}}</div>
                                                </div>
	...
	export default {
        name : 'page',
	  	components: {
            ...
            [Image.name] : Image,
            [Popup.name] : Popup,
	    	vipprice,hotsale,shopjoin,good,shoplist
	  	},
	  	data : function(){
	  		return {
                inited : false,
