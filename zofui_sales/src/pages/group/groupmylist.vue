                        ...
                        <div @click="link" :data-url="item.appurl" >
                            ...
                            <div class="mid thin-border_t thin-border_b">
                                <div class="info thin-border_r">
                                    <div class="price color-pri" v-if="item.oldprice*1 > 0">{{item.oldprice}}</div>
                                    <div class="name">原价</div>
                                </div>
                                <div class="info thin-border_r">
                                    <div class="price color-pri">{{item.show_price}}</div>
                                    <div class="name">拼单价</div>
                                </div>
                                <div class="info">
                                    <div class="price color-pri">{{item.dismem}}</div>
                                    <div class="name">还差人数</div>
                                </div>
                            </div>
                        </div>
                        <div class="btm">
                            ...
                            <div class="btn bg-pri" @click="link" :data-url="'/groupinfo?id='+item.id">查看详情</div>
                        </div>
                    </div>
                </div>
                </van-list>
