    ...
    install(Vue){
        ...
        Vue.prototype.$util = { //全局方法
            ...
            apiUrl : function(options){
                var url = location.href.indexOf('http://127.0.0.1:8080') >= 0 || location.href.indexOf('http://192.168') >= 0 ? 'http://127.0.0.2/app/index.php?i=1&c=entry&do=index&op=self&m='+this.const.module : location.href;
                var host = location.href.indexOf('http://127.0.0.1:8080') >= 0 || location.href.indexOf('http://192.168') >= 0 ? '192.168.0.109' : window.location.host;
                var param = this.getQuery(url);
                var url = window.location.protocol+ '//' + host + '/app/index.php?i='+param.i+'&m='+this.const.module+'&c='+param.c;
            ...
            Murl : function(doo,op){
                var url = location.href.indexOf('http://127.0.0.1:8080') >= 0 || location.href.indexOf('http://192.168') >= 0 ? 'http://127.0.0.5/app/index.php?i=1&c=entry&do=index&op=self&m='+this.const.module : location.href;
                var host = location.href.indexOf('http://127.0.0.1:8080') >= 0 || location.href.indexOf('http://192.168') >= 0 ? '127.0.0.5' : window.location.host;
                var param = this.getQuery(url);
                return window.location.protocol+ '//' + host + '/app/index.php?i='+param.i+'&m='+this.const.module+'&c=entry&do='+doo+'&op='+op;
            },
            enBase64(str){
            ...
            http : function(doo,method,data,success,loading,fail){
                var self = this;
                ...
                if( method.toLowerCase() == 'post' ){
                    Vue.http.post(url,data,{
                        ...
                        if( res.body && res.body.errno == 1001 ){
                            Toast.fail({
                                ...
                                mask : true,
                                onOpened : function(){
                                    router.push({name:'login',params:{'type':res.body.data.type}});
                                }
                            });
                            return false;
                        }
                        if( res.body && res.body.data && res.body.data.token ){
                            self.cookie.set('token',res.body.data.token,888888);
                        }
            ...
            upimg(file,fn){
                ...
                var url = location.href.indexOf('http://127.0.0.1:8080') >= 0 || location.href.indexOf('http://192.168.0') >= 0 ? 'http://127.0.0.5/app/index.php?i=1&c=entry&do=index&op=self&m='+this.const.module : location.href;
                var host = location.href.indexOf('http://127.0.0.1:8080') >= 0 || location.href.indexOf('http://192.168') >= 0 ? '127.0.0.5' : window.location.host;
                var param = this.getQuery(url);
